            ...
            <div className="" ref={boardRef}>
                ...
                {showTaskForm ? (
                    ...
                    <div className='mx-2 flex items-center text-gray-500'>
                        <button className='flex items-center w-full p-1 rounded-sm hover:bg-cardbtn my-2' onClick={() => setShowTaskForm(true)}>
                            <HiPlusSm />
                            <p>Thêm thẻ</p>
                        </button>
                        <button className='p-1 rounded-sm hover:bg-cardbtn'><HiOutlineTemplate /></button>
                    </div>
                )}
            </div>
        </div>
